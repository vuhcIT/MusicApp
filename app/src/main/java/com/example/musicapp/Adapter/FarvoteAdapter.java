...
public class FarvoteAdapter extends RecyclerView.Adapter<FarvoteAdapter.ViewHolder>{

    Context context;
    ArrayList<BaiHat> baiHatArrayList;

    public FarvoteAdapter(Context context, ArrayList<BaiHat> baiHatArrayList) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.dong_farvote,parent,false);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(@NonNull View itemView) {
            super(itemView);
            txttenbaihat = itemView.findViewById(R.id.textviewfarvote);
            txttencasi = itemView.findViewById(R.id.textviewfarvotecasi);
            imghinhbaihat = itemView.findViewById(R.id.imageviewfarvote);
            imgluotthich = itemView.findViewById(R.id.imageviewfarvotelike);
